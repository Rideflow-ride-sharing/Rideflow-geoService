# RideFlow — Geo Service

## Overview
The Geo Service handles all location-based operations in the RideFlow ride-hailing platform. It manages driver locations, finds nearby drivers, and provides geospatial queries essential for matching riders with drivers.
...
- **Geospatial Indexing**: Uses MongoDB 2dsphere indexes for efficient location queries
